Attribute VB_Name = "mComCompRawsGlobal"
Option Explicit
' ---------------------------------------------------------------------------
' Standard Module mComCompRawsGlobal
...
Private Property Get Value( _
    ...
    On Error GoTo eh
    Value = mFso.FilePrivProfValue(pp_file:=ComCompsSavedFileFullName _
...
' --------------------------------------------------
    ...
    On Error GoTo eh
    mFso.FilePrivProfValue(pp_file:=ComCompsSavedFileFullName _
              , pp_section:=pp_section _
              , pp_value_name:=pp_value_name _
               ) = pp_value
