Attribute VB_Name = "mBasic_RnmdByCompMan"
'Option Explicit
'' ----------------------------------------------------------------------------
...
'
'    Select Case a_default_excluded
'        Case False
'            lDims = ArryDims(a_arr)
'            lItems = 1
'            For i = 1 To lDims
'                If IsArray(a_arr(i)) Then ' "jagged" array!
'                    lItems = lItems + ArryItems(a_arr(i), a_default_excluded)
'                Else
