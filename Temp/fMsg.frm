...
Friend Property Let DsplyFrmsWthBrdrsTestOnly(ByVal b As Boolean)
...
Friend Property Let DsplyFrmsWthCptnTestOnly(ByVal b As Boolean):                       bDsplyFrmsWthCptnTestOnly = b:                                             End Property
...
Friend Property Let HmarginButtons(ByVal si As Single):                                 siHmarginButtons = si:                                                      End Property

Friend Property Let HmarginFrames(ByVal si As Single):                                  siHmarginFrames = si:                                                       End Property
...
Friend Property Get MaxFormHeight() As Single:                                          MaxFormHeight = siMaxFormHeight:                                            End Property

Friend Property Get MaxFormHeightPrcntgOfScreenSize() As Long:                          MaxFormHeightPrcntgOfScreenSize = lMaxFormHeightPoW:                        End Property

Friend Property Let MaxFormHeightPrcntgOfScreenSize(ByVal l As Long)
    lMaxFormHeightPoW = l
    ' The maximum form height must not exceed 70 % of the screen size !
    siMaxFormHeight = wVirtualScreenHeight * (Min(l, 70) / 100)
End Property

Friend Property Get MaxFormWidth() As Single:                                           MaxFormWidth = siMaxFormWidth:                                              End Property

Friend Property Get MaxFormWidthPrcntgOfScreenSize() As Long:                           MaxFormWidthPrcntgOfScreenSize = lMaxFormWidthPoW:                          End Property

Friend Property Let MaxFormWidthPrcntgOfScreenSize(ByVal l As Long)
...
Friend Property Let MinButtonWidth(ByVal si As Single):                                 siMinButtonWidth = si:                                                      End Property

Friend Property Get MinFormWidth() As Single:                                           MinFormWidth = siMinFormWidth:                                          End Property

Friend Property Let MinFormWidth(ByVal si As Single)
...
Friend Property Get MinFormWidthPrcntg() As Long:                                       MinFormWidthPrcntg = lMinFormWidthPoW:                                  End Property
...
Friend Property Let MsgButtons(ByVal v As Variant)
...
Friend Property Get MsgLabel(Optional ByVal section As Long) As String
...
Friend Property Let MsgLabel(Optional ByVal section As Long, ByVal s As String)
    If dctSectionsLabel Is Nothing Then Set dctSectionsLabel = New Dictionary
    dctSectionsLabel(section) = s
End Property

Friend Property Get MsgMonoSpaced(Optional ByVal section As Long) As Boolean
...
Friend Property Let MsgMonoSpaced(Optional ByVal section As Long, ByVal b As Boolean)
    If dctSectionsMonoSpaced Is Nothing Then Set dctSectionsMonoSpaced = New Dictionary
    dctSectionsMonoSpaced(section) = b
End Property

Friend Property Get MsgText(Optional ByVal section As Long) As String
...
Friend Property Let MsgText(Optional ByVal section As Long, ByVal s As String)
    If dctSectionsText Is Nothing Then Set dctSectionsText = New Dictionary
    dctSectionsText(section) = s
End Property

Friend Property Let MsgTitle(ByVal s As String):                                        sTitle = s: SetupTitle:                                                     End Property

Friend Property Get NoOfDesignedMsgSections() As Long
...
Friend Property Get ReplyIndex() As Long:       ReplyIndex = lReplyIndex:   Unload Me:  End Property

Friend Property Get ReplyValue() As Variant:    ReplyValue = vReplyValue:   Unload Me:  End Property

Friend Property Get VmarginButtons() As Single:                                         VmarginButtons = siVmarginButtons:                                          End Property

Friend Property Let VmarginButtons(ByVal si As Single):                                 siVmarginButtons = si:                                                      End Property

Friend Property Get VmarginFrames() As Single:                                          VmarginFrames = siVmarginFrames:                                            End Property

Friend Property Let VmarginFrames(ByVal si As Single):                                  siVmarginFrames = VgridPos(si):                                             End Property
